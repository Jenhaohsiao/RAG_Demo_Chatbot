...
const WorkflowStepper: React.FC<WorkflowStepperProps> = ({
  ...
  const [stepCompletion, setStepCompletion] = useState({
    1: false, // RAG Config
    2: false, // Prompt Config
    3: false, // Data Upload
    4: false, // Content Review
    5: false, // Text Processing
    6: false, // AI Chat
  });
